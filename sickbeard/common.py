...
class Quality:
    ...
    def nameQuality(name):
        ...
        elif checkName(["720p", "web.?dl|webrip|webhd(rip)?|netfilxhd"], all) or checkName(["720p", "(webhd|itunes)", "(h|x).?264"], all) or checkName(["720p", "(webhd|itunes)", "avc"], all):
            return Quality.HDWEBDL
        elif checkName(["1080p", "web.?dl|webrip|webhd(rip)?|netfilxhd"], all) or checkName(["1080p", "(webhd|itunes)", "(h|x).?264"], all):
