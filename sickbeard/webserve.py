    ...
    def saveProviders(self, newznab_string='',
        ...
        if newznab_string:
            for curNewznabProviderStr in newznab_string.split('!!!'):
                ...
                cur_name, cur_url, cur_key, cur_catid = curNewznabProviderStr.split('|')
                cur_url = config.clean_url(cur_url)

                newProvider = newznab.NewznabProvider(cur_name, cur_url, key=cur_key, catIDs=cur_catid)
                ...
                if cur_id in newznabProviderDict:
                    ...
                    newznabProviderDict[cur_id].catIDs = cur_catid
                    # a 0 in the key spot indicates that no key is needed
                    if cur_key == '0':
