...
class PostProcessor(object):
    ...
    def _list_associated_files(self, file_path, base_name_only=False):
        """
    ...
    def _analyze_name(self, name, file_name=True):
        ...
        self._log(u"Parsed " + fixed_name + " into " + str(parse_result).decode('utf-8', 'xmlcharrefreplace'), logger.DEBUG)
